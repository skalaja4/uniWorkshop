...
<%
	...
	String name = request.getAttribute("plan_name");
	String date = request.getAttribute("plan_date");
	String branch = request.getAttribute("plan_branch");
	Long id = Long.valueOf( request.getAttribute("plan_id"));
%>
